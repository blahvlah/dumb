sprites.onOverlap(SpriteKind.Player, SpriteKind.Food, function (sprite, otherSprite) {
    player1.say("AAAAAAAHHHHHHHHHHHHHHHHHH Spiders!")
    music.playMelody("C5 B C5 A G F G B ", 120)
})
